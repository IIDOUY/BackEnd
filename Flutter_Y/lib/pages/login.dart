...
class _LogInPageState extends State<LogInPage> {
  ...
  Future<void> _logIn(BuildContext context, String identifier, String password) async {
    ...
    if (response.statusCode == 200) {
      ...
      // _showDialog(context, "Login Success", 'Welcome back, ${data['username']}!');
      // ScaffoldMessenger.of(context).showSnackBar(
      //   SnackBar(content: Text('Welcome back, ${data['username']}!')),
      // );
      messager(context, "Welcome back! Glad to see you again ${data['username']}!", 'assets/icons/checked.png', isError: false);
      ...
      // );
      messager(context, "Invalid email or password.", 'assets/icons/annuler.png', isError: true);
    }
  }
