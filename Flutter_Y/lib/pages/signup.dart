...
import 'login.dart';
import 'home.dart';
import 'package:easelink/Utils/messager.dart';
...
Future<void> _signUp(BuildContext context) async {
  try {
    ...
    if (response.statusCode == 201) {
      ...
      messager(context, "Congratulations! Your account has been created successfully. You can now log in and start exploring.", 'assets/icons/succession.png', isError: false);
    } else {
      // throw Exception("Signup failed: ${response.body}");
      messager(context, "We had a problem while creating your account, please try again later.", 'assets/icons/annuler.png', isError: true);
    }
  } catch (e) {
    print("Error: $e");
